...
public class ExtraController implements Initializable {
    ...
    @FXML
    private JFXTreeTableView<Extra> tabla3;
    ...
    private void columnas() {
        ...
        JFXTreeTableColumn<Extra, Integer> longitud2 = new JFXTreeTableColumn<>("Longitud 2");
        longitud2.setEditable(false);

        longitud2.setCellValueFactory((TreeTableColumn.CellDataFeatures<Extra, Integer> param) -> {
        ...
        JFXTreeTableColumn<Extra, Integer> longitud3 = new JFXTreeTableColumn<>("Longitud 3");
        longitud3.setEditable(false);

        longitud3.setCellValueFactory((TreeTableColumn.CellDataFeatures<Extra, Integer> param) -> {
        ...
        JFXTreeTableColumn<Extra, Integer> longitud4 = new JFXTreeTableColumn<>("Longitud 4");
        longitud4.setEditable(false);

        longitud4.setCellValueFactory((TreeTableColumn.CellDataFeatures<Extra, Integer> param) -> {
        ...
        JFXTreeTableColumn<Extra, Integer> longitud5 = new JFXTreeTableColumn<>("Longitud 5");
        longitud5.setEditable(false);

        longitud5.setCellValueFactory((TreeTableColumn.CellDataFeatures<Extra, Integer> param) -> {
        ...
        JFXTreeTableColumn<Extra, Integer> longitud6 = new JFXTreeTableColumn<>("Longitud 6");
        longitud6.setEditable(false);

        longitud6.setCellValueFactory((TreeTableColumn.CellDataFeatures<Extra, Integer> param) -> {
        ...
        JFXTreeTableColumn<Extra, Integer> longitud7 = new JFXTreeTableColumn<>("Longitud 7");
        longitud7.setEditable(false);

        longitud7.setCellValueFactory((TreeTableColumn.CellDataFeatures<Extra, Integer> param) -> {
